...
## - 사용 기술: React Native, Spring Boot, JPA, MariaDB, AWS EC2, AWS Elastic Beanstalk

## - 성과: AWS EC2와 Elastic Beanstalk를 활용해 로드밸런싱 및 자동 스케일링 아키텍처를 구현, 이를 통해 시스템 가용성 99.9% 유지 및 동시 사용자 처리 능력을 2배 향상. 또한, 트래픽 증가 시 자동 확장을 통해 안정적인 서비스 제공 환경을 구축.
